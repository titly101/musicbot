...
BOT_TOKEN = getenv("7086881109:AAG9X9uNk5eH_4gh3vlWHRzAY4RXXkaMJvA")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID","-1002036934742") 
))
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/abhjkfv")
